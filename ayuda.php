  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div>
          <h1><a href="./files/funciones.pdf"><i class="fa fa-cog fa-lg"></i> Ayuda sobre Funciones</a></li></h1>
		  <h1><a href="./files/parametros.pdf"><i class="fa fa-cog fa-lg"></i> Ayuda sobre Parámetros</a></li></h1>
        </div>
      </div>
